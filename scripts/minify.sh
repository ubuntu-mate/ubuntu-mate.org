...
/usr/local/bin/pngquant --speed 1 --force --output www/Ubuntu-MATE-Remix.png files/Ubuntu-MATE-Remix.png
/usr/local/bin/pngquant --speed 1 --force --output www/Screenshot.png files/Screenshot.png
