...
.. date: 2015-03-06 05:13:37 UTC
.. tags: Ubuntu,MATE,Trusty,final,draft
.. link:
.. description:
.. type: text
...
The Ubuntu MATE 14.04.2 release is now available for download. This release
fixes a few issues that were present in 14.04.1, adds some new features and
...
There are advantages and disadvantages to maintaining an
unofficial Ubuntu derivative. The downside is that we have
not been able to integrate the hardware enablement stack
in Ubuntu MATE 14.04.2. 

You can of course install the hardware enablement stack yourself,
should you wish to do so.

  * https://wiki.ubuntu.com/Kernel/LTSEnablementStack

The upside of maintaining an unofficial Ubuntu deriative is 
that we can role out new features and package updates. So we did,
most notably LibreOffice 4.4.1.2.
...
He is what we've changed.
  ...
  * All MATE package updates from Debian have been synced to Ubuntu MATE 14.04.2
...
## Known Issues
  ...
  * Ubiquity reports that the install will require ~6Gb of disk on i386 and ~8Gb of disk on amd64.
    * In actual fact, both installs require ~4Gb of disk space.
